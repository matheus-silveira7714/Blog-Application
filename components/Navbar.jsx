...
const Navbar = () => {
  return (
    <div className=' h-16 sm:h-20 w-full flex items-center justify-between'>
      ...
      <div className="flex-1 text-left md:text-center font-bold sm:text-2xl text-xl">VBlog</div>
