...
const Post = ({ item }) => {
  return (
    <div className="mb-5 lg:mb-7 flex flex-col sm:flex-row w-full sm:items-center gap-3 sm:gap-5">
      <div className="flex-1 sm:h-[225px] lg:h-[300px] group overflow-hidden rounded-lg">
        <Image
          src={item.image}
          alt={item.title}
          width={275}
